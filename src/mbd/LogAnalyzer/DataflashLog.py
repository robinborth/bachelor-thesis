...
from src.mbd.LogAnalyzer.VehicleType import VehicleType, VehicleTypeString
...
#            "HELI_DUAL": 2,
    ...
    def read(self, logfile, format="auto", ignoreBadlines=False):
        ...
        if self.filename == '<stdin>':
            f = sys.stdin
        elif self.filename[-4:] == '.bin':
            f = open(self.filename, 'rb')
        elif self.filename[-4:] == '.log':
...
#     data = DataflashLog('D://dir//ardu_data - chosen//2018-07-12 13-25-17_battery low.log', format='auto',ignoreBadlines=True)